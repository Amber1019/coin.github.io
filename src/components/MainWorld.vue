            ...
            <div class="bg-[#212c42] p-5 rounded-md relative m-3">
                ...
                <div class="pb-5 flex items-center justify-center">
                    <div class="rounded-md w-full flex flex-col gap-3 max-h-[50rem] overflow-y-auto">
                        ...
                        <button
                        class="py-2 px-5 bg-gray-500 rounded-md w-max mx-auto hover:brightness-90 transition duration-150 select-none mb-2"
...
import { flipsPopupVisible,showFlipsPopup,selectedCurrency,filterInput,closeFlipsPopup } from '@/composables'
export default {
    name: 'MainWorld',
    components: { 
    WalletButton
